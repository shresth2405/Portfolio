...
function Project() {
  ...
  return (
    <div className="font-genesix text-gray-400 text-3xl">
      <ol className="flex flex-col gap-6">
        {/* <div className="text font-semibold mb-2">Some of my projects:</div> */}

        {/* Project 1 - CivicLedger */}
        <li>
          <h1 className="font-bold">1. CivicLedger</h1>
          <p className="text-2xl">
            ...
            <button onClick={() => toggleReadMore('civicLedger')} className="text-blue-500 underline ml-2">
              {showMore.civicLedger ? 'Read less' : 'Read more'}
            </button>
          </p>
          <div className="flex gap-8 font-light mt-2">
            <Link href="https://github.com/shresth2405/contracker1/tree/main" target="_blank">Github</Link>
        ...
        <li>
          <h1 className="text font-bold">2. Team Vibhav Official Site</h1>
          <p className="text-2xl">
            {showMore.teamVibhav ? (
              <>
            ...
            <button onClick={() => toggleReadMore('teamVibhav')} className="text-blue-500 underline ml-2">
              {showMore.teamVibhav ? 'Read less' : 'Read more'}
            </button>
          </p>
          <div className="flex gap-8 font-light mt-2">
            <Link href="https://github.com/shresth2405/Vibhav_2k25/tree/main" target="_blank">Github</Link>
            <Link href="https://vibhav-2k25-theta.vercel.app/" target="_blank">Live demo</Link>
          </div>
        </li>

        <li>
          <h1 className="font-bold">3. Youtube</h1>
          <p className="text-2xl">
            {showMore.youtube ? (
              <>
            ...
            <button onClick={() => toggleReadMore('youtube')} className="text-blue-500 underline ml-2">
              {showMore.youtube ? 'Read less' : 'Read more'}
            </button>
          </p>
          <div className="flex gap-8 font-light mt-2">
            <Link href="https://github.com/shresth2405/Backend-Project" target="_blank">Github</Link>
            {/* <Link href="https://contracker-six.vercel.app/" target="_blank">Live demo</Link> */}
          </div>
        </li>
